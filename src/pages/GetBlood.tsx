        ...
        <div className="mb-16">
          ...
          <div className="max-w-lg mx-auto">
            <FormCard
              ...
              description="রোগী এবং প্রয়োজনীয় রক্তের গ্রুপ সম্পর্কে বিস্তারিত সহ এই ফর্মটি পূরণ করুন। আমরা যত দ্রুত সম্ভব আপনার অনুরোধ প্রক্রিয়া করব।"
              formLink="https://forms.google.com"
              buttonText="রক্তের জন্য আবেদন করুন"
