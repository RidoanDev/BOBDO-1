  ...
  return (
    <div>
      <PageHeader
        ...
        description="বিওবিডিওর মিশন, ভিশন এবং সম্প্রদায়ের উপর আমাদের প্রভাব সম্পর্কে আরও জানুন।"
      />
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <p className="text-gray-700 mb-4">
            বিওবিডিও (বগুড়া অনলাইন ব্লাড ডোনেশন অর্গানাইজেশন) ২০১৬ সালে একটি
            সহজ মিশন নিয়ে প্রতিষ্ঠিত হয়েছিল: নিশ্চিত করা যে নিরাপদ রক্তের
            অভাবে কেউ মারা যাবে না। স্থানীয় রক্তদান কর্মসূচি আয়োজনকারী
            স্বেচ্ছাসেবকদের একটি ছোট দল হিসেবে শুরু হয়ে আজ এটি একটি ব্যাপক রক্ত
            ব্যবস্থাপনা সংস্থায় পরিণত হয়েছে যা প্রতি বছর হাজার হাজার মানুষকে
            সেবা প্রদান করে।
          </p>
          <p className="text-gray-700 mb-4">
            আমাদের প্রতিষ্ঠাতা, মোঃ সোহেল মিয়া, চিকিৎসা পেশাজীবী, সম্প্রদায়
            নেতা এবং নিবেদিত স্বেচ্ছাসেবকদের একত্রিত করে বিওবিডিও প্রতিষ্ঠা
            করেন।
          </p>
        ...
        <div className="max-w-4xl mx-auto my-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="p-4">
                <h3 className="font-bold text-lg">সয়েবুল খালিফ সোতন</h3>
